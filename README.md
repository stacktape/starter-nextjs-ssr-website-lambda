...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-nextjs-ssr-website-lambda)

- Simple Server-side rendered [Next.js](https://nextjs.org/) application.
- The project uses a purpose-built, optimized [Next.js resource](https://docs.stacktape.com/compute-resources/nextjs-website/) to
  run the Next app inside AWS Lambda (or Lambda@edge).
...
```bash
stacktape init --starterId nextjs-ssr-website-lambda
```
